...
class Config(object):
	API_ID = int(os.environ.get("API_ID", 8962471))
	API_HASH = os.environ.get("API_HASH", "27a3ded1ca63bb3d41d4b00a9be23fef")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6829508845:AAGSTk7PevpEOlkmkunC4gbfw4bKSMO4rD0")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "MaeveWileyRoBOT")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002076926143))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "1428665453"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://theshortmasti:mzXzqTbS98NYa9hE@cluster0.swexsbv.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001507970860")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001998176441")
	...
	LAZY_PIC = os.environ.get("LAZY_PIC","https://telegra.ph/file/0f3f0eb74d9cea2280636.jpg")
